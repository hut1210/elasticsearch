...
/**
 * Created by jinbeibei on 2018/1/12.
 */
public class HttpUtil {
     ...
     * @return
     */
    public static String sendPost(String url, String param, long connectionTimeout, long readTimeout) {
        ...
        try {
            ...
            conn.setReadTimeout((int) TimeUnit.SECONDS.toMillis(readTimeout));
