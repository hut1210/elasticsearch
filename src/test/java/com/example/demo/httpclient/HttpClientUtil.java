...
public class HttpClientUtil {
    ...
    public static void main(String[] args) {
        String url = "http://localhost:8080/test/index";
        Map map=new HashMap();
        map.put("name", "test1");
        map.put("age", "20");

        Map param = new HashMap();
        param.put("testDto",JSONObject.toJSONString(map));
    ...
    public static void doPostTestThree() {
        ...
        String url = "http://localhost:8080/test/index";
        Map map=new HashMap();
        map.put("testDto", TestDto.builder().name("test1").age(20).build());
        map.put("testDto2", TestDto.builder().name("test2").age(22).build());
