...
public enum CommonDeliveryEnum {
    ...
    SINGEDIN_AMOUNT(3, "已签收单量", "以选择时间条件为基础，统计所有目的网点为西藏网点的已签收单量",400),
    CANCEL_AMOUNT(4, "取消单量", "以选择时间条件为基础，统计所有目的网点为西藏网点的取消单量",20),
    REJECTION_AMOUNT(5, "拒收单量", "以选择时间条件为基础，统计所有目的网点为西藏网点的拒收单量",10),
    ;
