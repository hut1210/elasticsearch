...
public class XZReportUtils {
    ...
    private static void analySearchResponse1(Terms.Bucket bucket, List<Map<String,String>> list, HashMap<String,String> preMap, int index, TermsAggregationCondition... conditions){
        ...
        map.put(condition.getGroupField()+"_doc_count", XZReportUtils.getBigDecimal(bucket.getDocCount()).toString());
        ...
        for(Map.Entry<String,String> entry : condition.getSum().entrySet()){
            ...
            if(bucket != null && bucket.getAggregations().get(name) != null){
                ...
                map.put(condition.getGroupField()+"_"+name, XZReportUtils.getBigDecimal(sum.getValue(),2).toString());
            }
        }
        ...
        for(Map.Entry<String,String> entry : condition.getMin().entrySet()){
            ...
            if(bucket != null && bucket.getAggregations().get(name) != null){
                ...
                map.put(condition.getGroupField()+"_"+name, XZReportUtils.getBigDecimal(min.getValue(),2).toString());
            }
        }
        ...
        for(Map.Entry<String,String> entry : condition.getMax().entrySet()){
            ...
            if(bucket != null && bucket.getAggregations().get(name) != null){
                ...
                map.put(condition.getGroupField()+"_"+name, XZReportUtils.getBigDecimal(max.getValue(),2).toString());
            }
        }
        ...
        for(Map.Entry<String,String> entry : condition.getAvg().entrySet()){
            ...
            if(bucket != null && bucket.getAggregations().get(name) != null){
                ...
                map.put(condition.getGroupField()+"_"+name, XZReportUtils.getBigDecimal(avg.getValue(),2).toString());
            }
        }
        ...
        if(StringUtils.isNotBlank(condition.getCardinality())){
            if(bucket != null && bucket.getAggregations().get(AggregationHelper.AGG_CARDINALITY_TERM) != null){
                ...
                map.put(condition.getCardinality()+"_cardinality", XZReportUtils.getBigDecimal(cardinality.getValue(), 2).toString());
            }
        }
